...
fn calculate_checksum(data: &[u8]) -> u16 {
    ...
    \footnotetext{Rust-ohjelmointikielessä \textit{paniikki} viittaa virheeseen, josta ei voi palautua. Paniikki johtaa aina prosessin sammumiseen \cite[luku 9.3]{rust-book}.}
...
32, 87, 111, 114, 108, 100])
    ...
    \begin{enumerate}
        ...
        \item \lstinline{Send} on erittäin tärkeä tieto sulkeumasta. Tämä tarkoittaa sitä, että sulkeuma ja sen käyttämien asioiden täytyy olla turvallisia säikeiden välistä siirtoa varten. Tämä tarkoittaa myös sitä, että demosovelluksen tilarakenne on turvallista siirtää toiseen säikeeseen.
