...
\begin{framed}
    C-ohjelmointikielessä kokonaisluvun ylivuoto on määrittelemätön tapahtuma. Tämä voi ja on johtanut useisiin tietoturva ongelmiin. Se saattaa olla usein myös vaikeita löytää sillä C-ohjelma jatkaa toimintaa vaikka ylivuoto tapahtuu.\par
